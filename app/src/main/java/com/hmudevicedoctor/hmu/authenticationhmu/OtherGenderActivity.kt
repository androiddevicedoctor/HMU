...
class OtherGenderActivity : AppCompatActivity() {
    ...
    private fun onclick() {
        Transgender.setOnClickListener {
            ...
            Transgender.setTextColor(
                ContextCompat.getColor(
                    this@OtherGenderActivity,
                    R.color.white
                )
            )
            val str = "Transgender"
        ...
        back_button.setOnClickListener {
            startActivity(Intent(this@OtherGenderActivity, GenderActivity::class.java))
        }
    }
                ...
                if (documentSnapshot.exists()) {
                    ...
                    userDocRef.set(user!!)
                        .addOnSuccessListener {
                            startActivity(Intent(this@OtherGenderActivity, FlotsBoat::class.java))
                        }
                        .addOnFailureListener { e ->
                            Toast.makeText(this@OtherGenderActivity, "Check your internet connection....", Toast.LENGTH_SHORT).show()
                        }
                } else {
                    Toast.makeText(this@OtherGenderActivity, "User does not exist", Toast.LENGTH_SHORT)
                        .show()
                }
            }
            .addOnFailureListener { e ->
                Toast.makeText(this@OtherGenderActivity, "Error fetching user data", Toast.LENGTH_SHORT)
                    .show()
            }
    }
}